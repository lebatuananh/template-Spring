    ...
    <div class="top-sec">
        <div class="container ">
            <div class="row match-height-container">
                ...
                <div class="col-sm-5 popular-tags wow fadeInDown animated" data-wow-delay="1s"
                     data-wow-offset="40">
                ...
                <div class="col-sm-5 recent-posts wow fadeInDown animated" data-wow-delay="1s"
                     data-wow-offset="40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="f-sub-info">
                                        <div class="time"><span class="ion-android-data icon"></span>Dec 16 2014
                                        </div>
                ...
                <div class="col-sm-16">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-16 copyrights text-right wow fadeInDown animated"
                             data-wow-delay="0.5s" data-wow-offset="10">© 2014 GLOBALNEWS THEME - ALL RIGHTS
                            RESERVED
                        </div>
                    </div>
                </div>
